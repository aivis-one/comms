...
#                        + profile type-key check  (app/engine/profile.py)
#   MAX_CATEGORY_LEN  -- category_mutes.category   (app/audience/models.py)
#                        + profile category check  (app/engine/profile.py)
#
...
#   columns at import time. That was honest, but it made engine/profile
#   import audience/models while audience/prefs already imports
#   engine/registry -- the two packages became MUTUALLY dependent.
